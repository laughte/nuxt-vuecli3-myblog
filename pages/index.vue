      ...
      <v-row justify="center">
        <v-col xl="5" lg="7" md="8" sm="8" xs="12">
          <v-card
            ...
            flat
            class="mb-2"
            v-for="(item,index) in $store.state.article.slice((page-1)*7,7*page)"
            :key="index"
          >
            ...
            <v-list-item three-line>
              ...
              <v-list-item-content class="align-self-start">
                ...
                <v-list-item-title class="mb-2" v-if="item.blocks[0]">{{item.blocks[0].data.text}}</v-list-item-title>
          ...
          <div class="text-center" v-if="Math.ceil($store.state.article.length/7)>1">
            <a href="#" style="text-decoration:none">
              <v-pagination
                circle
                v-model="page"
                :length="Math.ceil($store.state.article.length/7)"
        ...
        <v-col v-if="$store.state.article.length>0" xl="3" lg="4" md="4" sm="4">
