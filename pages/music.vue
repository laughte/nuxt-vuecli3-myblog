          ...
          <v-list dense>
            ...
            <v-list-item two-line>
              <v-list-item-avatar size="45" tile>
                <v-btn to="/music/songDetail" color="white" style="position: absolute; z-index:8" class="sqIcon" icon> <v-icon large>mdi-fullscreen</v-icon> </v-btn>
                <v-img   v-if="$store.state.music.album" :src="$store.state.music.album.picUrl?$store.state.music.album.picUrl:$store.state.music.album.coverImgUrl"></v-img>
              </v-list-item-avatar>
